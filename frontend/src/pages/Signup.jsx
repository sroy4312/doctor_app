...
import uploadImageToCloud from "../utils/uploadImages";
...
const Signup = () => {
  ...
  const handleFileInputChange = async(e) => {
    ...
    //later some api will be used to upload images
            ...
            <form onSubmit={handleOnSubmit}>
              ...
              <div className="mt-7">
                <button
                  ...
                  type="submit"
                  className="w-full bg-primaryColor text-white text-[15px] leading-[30px] rounded-lg px-4 py-3 uppercase font-semibold"
                >
                  {loading ? <HashLoader size={35} color="#fff" /> : 'Create account'}
                </button>
              </div>
