...
const DoctorCard = ({item}) => {
  const { name, specialization, avgRating, totalRating, photo, totalPatients, hospital } = item;
  return (
    <div className='p-3 lg:p-5'>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            ...
            <Link to={'/doctors/1'} className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none"><BsArrowRight className="group-hover:text-[#ffffff] w-6 h-5" /></Link>
        </div>
    </div>
  )
}
